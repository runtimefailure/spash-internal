...
void c_gui::styles() 
{
	...
	colors[ImGuiCol_FrameBgHovered]			= ImVec4(0.24f, 0.31f, 0.35f, 1.00f);
	colors[ImGuiCol_FrameBgActive]			= ImVec4(0.28f, 0.37f, 0.41f, 1.00f);
...
void c_gui::render()
{
	...
	ImGui::Text("veri detected");
	ImGui::Separator();
	ImGui::Text("copyright to diego (c) 2069");
